...
const Index = () => {
  ...
  const npaData = [
    { id: 1, title: 'ТК РФ Глава 34. Охрана труда', date: '01.01.2024', category: 'Законы', status: 'active' },
    { id: 2, title: 'Приказ Минтруда России от 29.10.2021 N 774н', date: '15.12.2023', category: 'Приказы', status: 'active' },
    { id: 3, title: 'ГОСТ 12.0.004-2015 ССБТ', date: '20.11.2023', category: 'ГОСТы', status: 'active' },
    { id: 4, title: 'СП 2.2.3670-20 Санитарные правила', date: '10.10.2023', category: 'СанПиН', status: 'active' },
  ];
